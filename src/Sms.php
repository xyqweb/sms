...
class Sms
{
     ...
     *
     * @return \xyqWeb\sms\Contracts\GatewayInterface
     *
     * @throws \xyqWeb\sms\Exceptions\InvalidArgumentException
     */
    ...
    /**
     * @param string|\xyqWeb\sms\Contracts\PhoneNumberInterface $number
     *
     * @return \xyqWeb\sms\PhoneNumber
     */
    ...
    /**
     * @param array|string|\xyqWeb\sms\Contracts\MessageInterface $message
     *
     * @return \xyqWeb\sms\Contracts\MessageInterface
     */
